...
2026-09-05 반영: 광역철도, 지하철·도시철도 연장/신설, GTX, 철도 예타·기본계획·역세권을 별도로 검색한다. 제목에 철도 노선과 사업 진행 정보가 함께 있는 후보는 전체 30건 제한을 적용하기 전에 최대 5건을 목록 최상단에 배치한다. 당일 관련 기사가 5건보다 적으면 확보된 기사만 올리고 남은 자리는 일반 후보로 채운다. 개통 기념 행사·여행 공모·사고 등은 철도 우선 배치에서 제외한다. 사용자에게 이미 제시한 당일 기사 번호는 재수집으로 변경하지 않는다.
