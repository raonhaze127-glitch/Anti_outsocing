...
.photo-bg{position:absolute;inset:0;z-index:0;background-size:cover;background-position:center;opacity:.96;filter:saturate(1.04) contrast(1.06) brightness(1.05);pointer-events:none}.photo-bg:after{content:"";position:absolute;inset:0;background:linear-gradient(90deg,rgba(5,10,18,.66) 0%,rgba(6,13,24,.53) 44%,rgba(6,13,24,.34) 100%),linear-gradient(180deg,rgba(8,20,38,.10),rgba(0,0,0,.56));}.cover .photo-bg{opacity:.98}.table .photo-bg{opacity:.94}.summary .photo-bg{opacity:.94}
